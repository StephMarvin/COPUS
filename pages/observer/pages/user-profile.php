      ...
      <div class="col-xl-4">
        ...
        <div class="card">
          <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
            ...
            <h3> <?php echo htmlspecialchars($department_code . " " . $role); ?> </h3>
        ...
        <div class="card">
          <div class="card-body pt-3">
            ...
            <ul class="nav nav-tabs nav-tabs-bordered">
              ...
              <li class="nav-item">
                <button class="nav-link" data-bs-toggle="tab" data-bs-target="#other-information"> Observer Details </button>
              </li>
            ...
            <div class="tab-content pt-2">
                  ...
                  <div class="col-lg-12">
                    ...
                    <div class="container">
                      ...
                      <div class="row">
                        ...
                        <div class="col">
                          <div class="mb-1 mt-1">
                            <label class="form-label"> Role and Designation: </label>
                            <input type="text" class="form-control" value="<?php echo htmlspecialchars($role . " | " . $designation); ?>" readonly disabled>
                          </div>
                        </div>
                      </div>
              ...
              <div class="tab-pane fade <?php echo htmlspecialchars($active_tab === "profile" ? "show active" : ""); ?> pt-3" id="edit-information">
                ...
                <!-- Profile Edit Form -->
                <form action="../../process/observer/profile-update.php" method="POST" class="custom-form">
              ...
              <div class="tab-pane fade <?php echo htmlspecialchars($active_tab === "photo" ? "show active" : ""); ?> pt-3" id="picture-edit">
                ...
                <!-- Profile Edit Form -->
                <form action="../../process/observer/profile-update.php" method="POST" enctype="multipart/form-data">
              ...
              <div class="tab-pane fade <?php echo htmlspecialchars($active_tab === "password" ? "show active" : ""); ?> pt-0" id="change-password">
                  ...
                  <div class="container">
                    ...
                    <form action="../../process/observer/profile-update.php" method="POST" id="toggle-two-factor">
