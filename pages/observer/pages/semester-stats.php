<?php
    ...
    $get_student_action_averages = $conn->prepare("SELECT
                                                        ...
                                                        WHERE ot.semester_id = :semester_id AND ot.department_id = :department_id
                                                        GROUP BY sa.action_name
                                                        ORDER BY avg_tally DESC
                                                    ");
    $get_student_action_averages->execute([":semester_id" => $semester_id, ":department_id" => $department_id]);
    ...
    $get_teacher_action_averages = $conn->prepare("SELECT
                                                        ...
                                                        ORDER BY avg_tally DESC
                                                    ");
    $get_teacher_action_averages->execute([":semester_id" => $semester_id, ":department_id" => $department_id]);
                    ...
                    <div class="col-12">
                        ...
                        <div class="card shadow mb-3">
                            ...
                            <div class="d-flex justify-content-between align-items-center px-4 py-2 custom-bg mb-2">
                                <h5 class="card-title custom-card-title text-white"> Student Actions Averages This Semester </h5>
                                ...
                                if ($student_label && $student_action_avg_tally) { ?>
                                    <button
                                        ...
                                        '<?php echo htmlspecialchars($department_code . '_Student_Actions_Averages_A_Y_' . $academic_year . '_' . $semester); ?>',
                                        'l'
                                    )">
                                        Download Chart
                                    </button>
                            ...
                            <div class="d-flex justify-content-between align-items-center px-4 py-2 custom-bg mb-2">
                                ...
                                if ($teacher_label && $teacher_action_avg_tally) { ?>
                                    ...
                                    <button
                                        ...
                                        '<?php echo htmlspecialchars($department_code . '_Teacher_Actions_Averages_A_Y_' . $academic_year . '_' . $semester); ?>',
                                        'l'
                                    )">
                                        Download Chart
                                    </button>
                    ...
                    <script>
                        document.addEventListener("DOMContentLoaded", function() {
                            convertDataToChart(
                                ...
                                "Student Actions Averages: A.Y. <?php echo htmlspecialchars($academic_year . ", " . $semester); ?>",
                                "bar"
                            );
                        });
