            ...
            <div>
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"> <a href="home.php?page=observations-this-semester"> Observations this Semester </a></li>
                    ...
                    <div class="card-body" id="observation_summary_<?php echo htmlspecialchars($observation_id); ?>">
                        ...
                        ?>
                            <div class="mt-3 mb-3 p-2">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <h5> Department: <span class="fw-bold">
                                            <?php echo htmlspecialchars($observation_data->department_name . " (" . $observation_data->department_code .")"); ?></span> 
                                        </h5>
                                    </div>
                                </div>
