            ...
            <div class="col-lg-12">
                ...
                <div class="card shadow">
                    ...
                    <div class="d-flex justify-content-between align-items-center px-4 py-2 custom-bg mb-2">
                        <h5 class="card-title custom-card-title text-white"> Observed Classes this Semester </h5>
                    </div>
                                ...
                                <tbody>
                                    <?php
                                        $get_observation_list = $conn->prepare("SELECT
                                                                        ...
                                                                        WHERE 
                                                                        ay.status = :ay_status AND 
                                                                        s.semester_status = :semester_status AND
                                            ...
                                            while($observation_data = $get_observation_list->fetch()) {
                                                ?>
                                                    <tr class="fw-bold">
                                                        ...
                                                        <td>
                                                            <a href="home.php?page=observation-summary&observation-id=<?php echo htmlspecialchars(base64_encode($observation_data["observation_id"])); ?>" class="btn btn-primary custom-add-btn" > 
                                                                Details 
                                                            </a> 
                                                        </td>
                                                    </tr>
