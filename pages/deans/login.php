                    ...
                    <div class="col-md-8 col-lg-6 col-xxl-3">
                        <div class="card mb-0">
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-center"> Login as Dean </p>

                                <form action="../../process/dean/dean-auth.php" method="POST">
                                    <div class="mb-3">
                                    ...
                                    <input type="submit" name="dean-login" value="Sign In" class="btn btn-primary w-100 py-8 fs-4 mb-2 rounded-2 custom-btn">
