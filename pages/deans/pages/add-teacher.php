            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="px-3">
                            <h5 class="card-title custom-card-title mb-0"> Add New Teacher </h5>
                        ...
                        <form action="../../process/dean/account-management.php" method="POST" class="custom-form" autocomplete="off">
                            ...
                            <div class="container mt-1">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        ...
                                        <select class="form-select" name="teacher-rank" required>
                                            <option selected disabled value=""> SELECT TEACHER RANK </option>
                                            <option value="Instructor"> Instructor </option>  
                                            <option value="Assistant Professor"> Assistant Professor </option>
                                            <option value="Associate Professor"> Associate Professor </option>
                                            <option value="Professor"> Professor </option>
                                            <option value="Exemplary Teacher"> Exemplary Teacher </option>
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="confirm-add">
                                                I hereby confirm the addition of this new teacher account to the system.
                                            </label>
                                ...
                                <button type="submit" name="add-new-teacher" class="btn btn-primary custom-add-btn" > Add Teacher </button>
