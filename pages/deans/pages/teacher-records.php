            ...
            <div class="col-lg-12">
                ...
                <div class="card shadow">
                    ...
                    <div class="d-flex justify-content-between align-items-center px-4 py-2 custom-bg mb-2">
                        <h5 class="card-title custom-card-title text-white"> Teacher Records </h5>
                    </div>
                            ...
                            <table class="table table-striped table-hover custom-table datatable">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col"> Total Observations </th>    
                                ...
                                <tbody>
                                    <?php
                                        $get_teacher_list = $conn->prepare("SELECT
                                                                        ...
                                                                        WHERE tc.department_id = :department_id
                                                                        GROUP BY tc.id_number, tc.first_name, tc.last_name, ti.profile_picture
                                                                        ORDER BY tc.last_name ASC
                                                                        ");

                                        $get_teacher_list->execute([":observe_status" => "Complete", ":copus_type" => "Summative", ":department_id" => $department_id]);
                                            ...
                                            while($teacher_record_data = $get_teacher_list->fetch()) {
                                                ...
                                                ?>
                                                    <tr class="fw-bold">
                                                        ...
                                                        <td> 
                                                            <a href="home.php?page=teacher-observation-records&id-number=<?php echo htmlspecialchars(base64_encode($teacher_record_data["id_number"])); ?>" class="btn btn-primary custom-add-btn" > 
                                                                View Records 
                                                            </a> 
                                                        </td>
                                                    </tr>
