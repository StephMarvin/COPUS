...
<aside id="sidebar" class="sidebar">
  ...
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
      ...
      <?php
        $list_active = [
          "teachers-list", "add-teacher", "teacher-details",
          "observers-list", "add-observer", "observer-details"
        ];

        $list_page_active = in_array($page_name, $list_active);
      ?>

      <a class="nav-link <?= $list_page_active ? '' : 'collapsed' ;?>" data-bs-target="#faculty-list-nav" data-bs-toggle="collapse" href="#">
        <i class="bi bi-people-fill"></i> <span> Faculty List </span> <i class="bi bi-chevron-down ms-auto"></i>
      </a>

      <ul id="faculty-list-nav" class="nav-content collapse <?= $list_page_active ? 'show' : '' ;?>" data-bs-parent="#sidebar-nav">

        <li class="<?= ($page_name === "teachers-list" || $page_name === "add-teacher" || $page_name === "teacher-details") ? 'active-page' : '' ;?>">
          <a href="home.php?page=teachers-list">
            <i class="bi bi-person-fill-check"></i> <span> Teachers List </span>
          </a>
        </li>

        <li class="<?= ($page_name === "observers-list" || $page_name === "add-observer" || $page_name === "observer-details") ? 'active-page' : '' ;?>">
          <a href="home.php?page=observers-list">
            <i class="bi bi-person-workspace"></i> <span> Observers List </span>
          </a>
        </li>
    ...
    <!-- Subjects -->
    <li class="nav-item">
      <a class="nav-link <?php echo htmlspecialchars($page_name === "subjects" ? "" : "collapsed"); ?>" href="home.php?page=subjects">
