            ...
            <div class="col-lg-12">
                ...
                <div class="card shadow mb-3">
                    ...
                    <div class="d-flex justify-content-between align-items-center px-4 py-2 custom-bg mb-4">
                        <h5 class="card-title custom-card-title text-white"> List of Teacher Actions </h5>
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-striped table-hover custom-table mb-1 datatable">
                            ...
                            <?php
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form action="../../process/admin/action-management.php" method="POST" autocomplete="off">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="submit" name="update-teacher-action" class="btn btn-primary custom-add-btn"> Update Action </button>     
                                </form>
                                                        <form action="../../process/admin/action-management.php" method="POST" id="set-action-status">
                                                            <input type="hidden" name="action-id" value="<?php echo htmlspecialchars(base64_encode($action_data["action_id"])); ?>">
                                                        
                                                        <?php if($action_data["action_status"] === "Active") { ?>

                                                            <input type="hidden" name="set-teacher-action-inactive" value="1">
                                                        ...
                                                        <?php } else { ?>
                                                            ...
                                                            <input type="hidden" name="set-teacher-action-active" value="1">
                                ...
                                ?>
                                    <tr>
                                        <td colspan="6"> No teacher actions yet. </td>
                                    </tr>
                                <?php
                                }
                            ?>
        ...
        <div class="modal-content">
            ...
            <form action="../../process/admin/action-management.php" method="POST" autocomplete="off">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="add-new-teacher-action" class="btn btn-primary custom-add-btn"> Add New Action </button>
                </div>
