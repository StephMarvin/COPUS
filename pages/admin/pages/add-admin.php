            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="px-3">
                            <h5 class="card-title custom-card-title mb-0"> Add New Admin </h5>
                        ...
                        <form action="../../process/admin/account-management.php" method="POST" class="custom-form">
                            ...
                            <div class="container mt-1">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="confirm-add">
                                                I hereby confirm the addition of this new administrator account to the system.
                                            </label>
                                ...
                                <button type="submit" name="add-new-admin" class="btn btn-primary custom-add-btn" > Add Admin </button>
