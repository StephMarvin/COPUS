            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="px-3">
                            <h5 class="card-title custom-card-title mb-0"> Add New Dean </h5>
                            <p class="lh-1 mb-0 text-muted"> Please ensure that all information provided is accurate. </p>
                        </div>

                        <hr>

                        <form action="../../process/admin/account-management.php" method="POST" class="custom-form">
                            ...
                            <div class="container mt-1">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <select class="form-select" name="department-id" required>
                                            ...
                                            <?php
                                                $get_departments = $conn->prepare("SELECT * FROM departments_tbl WHERE department_status = :department_status");
                                                $get_departments->execute([":department_status" => "Active"]);

                                                while($department_data = $get_departments->fetch()) {
                                            ?>
                                                <option value="<?php echo htmlspecialchars($department_data["department_id"]); ?>">
                                                    <?php echo htmlspecialchars($department_data["department_name"]); ?> (<?php echo htmlspecialchars($department_data["department_code"]); ?>)
                                                </option>
                                            <?php
                                                }
                                            ?>
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="confirm-add">
                                                I hereby confirm the addition of this new dean account to the system.
                                            </label>
                                ...
                                <button type="submit" name="add-new-dean" class="btn btn-primary custom-add-btn" > Add Dean </button>
