                            ...
                            <div class="tab-pane fade" id="update-designation">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <form action="../../process/admin/account-management.php" method="POST" class="custom-form" id="set-designation-form">
                                        ...
                                        <div class="container mt-0">
                                            ...
                                            <div class="row mt-3">
                                                <div class="col">
                                                    ...
                                                    <input type="hidden" name="archive-observer-account" value="1">
                                                    <button
                                                        type="submit"
                                                        class="btn btn-danger"
                                                        onclick="confirmAction(
                                                                    ...
                                                                    'Archive Account?', 
                                                                    'question',
                                                                    'Are you sure you want to archive <?php echo htmlspecialchars($fetched_observer_details->first_name . ' ' . $fetched_observer_details->last_name); ?>\'s account?',
                                                                    'Archive Account',
                                                                    '#dc3545'
                                                                )"
