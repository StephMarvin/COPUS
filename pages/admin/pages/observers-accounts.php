            ...
            <div class="col-lg-12">
                ...
                <div class="card shadow">
                    ...
                    <div class="d-flex justify-content-between align-items-center px-4 py-2 custom-bg mb-2">
                        <h5 class="card-title custom-card-title text-white"> Observers Accounts </h5>
                    </div>
                                ...
                                <tbody>
                                    <?php
                                        $get_observer_list = $conn->prepare("SELECT
                                                                        ...
                                                                        WHERE oc.is_archived = 'No'
                                                                        ORDER BY oc.last_name ASC
                                                                        ");

                                        $get_observer_list->execute();
                                        ...
                                        if($get_observer_list->rowCount() > 0) {
                                            ...
                                            ?>
                                                <tr>
                                                    <td colspan="9"> No observer data available. </td>
                                                </tr>
                                            <?php
                                        }
                                    ?>
