...
<head>
  ...
  <title> COPUS: Administrator Login </title>
                    ...
                    <div class="col-md-8 col-lg-6 col-xxl-3">
                        <div class="card mb-0">
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-center"> Login as Administrator </p>
                                ...
                                <form action="../../process/admin/admin-auth.php" method="POST">
                                    ...
                                    <input type="submit" name="admin-login" value="Sign In" class="btn btn-primary w-100 py-8 fs-4 mb-2 rounded-2 custom-btn">
