      ...
      <div class="col-xl-4">
        ...
        <div class="card">
          <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
            ...
            <h3> <?php echo htmlspecialchars($department_code . " " . $teacher_rank); ?> </h3>
        ...
        <div class="card">
          <div class="card-body pt-3">
            ...
            <ul class="nav nav-tabs nav-tabs-bordered">
              ...
              <li class="nav-item">
                <button class="nav-link" data-bs-toggle="tab" data-bs-target="#other-information"> Teacher Details </button>
              </li>
            ...
            <div class="tab-content pt-2">
                      ...
                      <div class="row">
                        <div class="col">
                          <div class="mb-1 mt-1">
                            ...
                            <input type="text" class="form-control" value="<?php echo htmlspecialchars($department_name . " (" . $department_code . ")"); ?>" readonly disabled>
                          </div>
                        </div>
                      ...
                      <div class="row">
                        <div class="col">
                          <div class="mb-1 mt-1">
                            ...
                            <input type="text" class="form-control" value="<?php echo htmlspecialchars($employment_status); ?>" readonly disabled>
                          </div>
                        </div>
                        ...
                        <div class="col">
                          <div class="mb-1 mt-1">
                            ...
                            <input type="email" class="form-control" value="<?php echo htmlspecialchars($teacher_rank); ?>" readonly disabled>
                          </div>
                        </div>
              ...
              <div class="tab-pane fade <?php echo htmlspecialchars($active_tab === "profile" ? "show active" : ""); ?> pt-3" id="edit-information">
                  ...
                  <!-- Profile Edit Form -->
                <form action="../../process/teacher/profile-update.php" method="POST" class="custom-form">
              ...
              <div class="tab-pane fade <?php echo htmlspecialchars($active_tab === "photo" ? "show active" : ""); ?> pt-3" id="picture-edit">
                ...
                <!-- Profile Edit Form -->
                <form action="../../process/teacher/profile-update.php" method="POST" enctype="multipart/form-data">
              ...
              <!-- Change Password -->
              <div class="tab-pane fade <?php echo htmlspecialchars($active_tab === "password" ? "show active" : ""); ?> pt-0" id="change-password">
                  ...
                  <div class="container">
                    ...
                    <form action="../../process/teacher/profile-update.php" method="POST" id="toggle-two-factor">
