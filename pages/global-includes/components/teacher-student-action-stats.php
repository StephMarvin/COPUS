<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["select-teacher"])) {
        ...
        $get_current_teacher = $conn->prepare("SELECT id_number FROM teacher_credentials_tbl ORDER BY last_name ASC LIMIT 1");
        $get_current_teacher->execute();
            ...
            <div class="d-flex justify-content-between align-items-center gap-3">
                ...
                <div>
                    ...
                    <form action="home.php?page=student-stats" method="POST" class="d-flex justify-content-between align-items-center gap-2">
                       ...
                       <?php
                            $fetch_teachers = $conn->prepare("SELECT id_number, first_name, last_name FROM teacher_credentials_tbl ORDER BY last_name ASC");
